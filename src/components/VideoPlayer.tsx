...
import { 
  X, Volume2, VolumeX, Maximize, Minimize, Play, Pause, 
  SkipBack, SkipForward, Settings, Radio, Clock, Zap, 
  Signal, Heart, Share2, Airplay, Captions, Pip
} from 'lucide-react';
      ...
      >
            ...
            <div className="backdrop-blur-xl bg-black/40 border border-white/10 rounded-2xl p-6 shadow-2xl">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button className="p-3 rounded-full bg-white/5 hover:bg-white/10 transition-all border border-white/10 hidden md:flex">
                    <Airplay className="w-5 h-5 text-white/70 hover:text-white" />
                  </button>
                  ...
                  >
                    {isFullscreen ? (
                      <Minimize className="w-5 h-5 text-white/70 hover:text-white" />
                    ) : (
        ...
        {!isLoading && !error && (
          <div className="absolute top-24 right-6 z-30">
            <div className="px-3 py-1.5 rounded-full bg-black/60 backdrop-blur-sm border border-white/10 shadow-lg">
